...
[VolumeComponentMenu("Post-processing Custom/Sepia")]

// If the related Scriptable Renderer Feature doesn't exist, display a warning about adding it to the renderer.
[VolumeRequiresRendererFeatures(typeof(SepiaRendererFeature))]
...
public sealed class SepiaVolumeComponent : VolumeComponent, IPostProcessComponent
{
    // Set the name of the volume component in the list in the Volume Profile.
    public SepiaVolumeComponent()
    {
        displayName = "Sepia";
    }
