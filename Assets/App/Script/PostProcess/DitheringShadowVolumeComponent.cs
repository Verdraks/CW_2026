...
[VolumeComponentMenu("Post-processing Custom/DitheringShadow")]

// If the related Scriptable Renderer Feature doesn't exist, display a warning about adding it to the renderer.
[VolumeRequiresRendererFeatures(typeof(DitheringShadowRendererFeature))]
...
public sealed class DitheringShadowVolumeComponent : VolumeComponent, IPostProcessComponent
{
    // Set the name of the volume component in the list in the Volume Profile.
    public DitheringShadowVolumeComponent()
    {
        displayName = "DitheringShadow";
    }
