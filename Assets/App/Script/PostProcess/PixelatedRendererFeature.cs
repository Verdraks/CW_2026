...
public sealed class PixelatedRendererFeature : ScriptableRendererFeature
{
    ...
    public override void AddRenderPasses(ScriptableRenderer renderer, ref RenderingData renderingData)
    {
        ...
        PixelatedVolumeComponent myVolume = VolumeManager.instance.stack?.GetComponent<PixelatedVolumeComponent>();
    ...
    private class CustomPostRenderPass : ScriptableRenderPass
    {
        ...
        private static readonly int kPixelsPropertyId = Shader.PropertyToID("_Pixels");
        ...
        private static void ExecuteMainPass(RasterCommandBuffer cmd, RTHandle sourceTexture, Material material)
        {
            ...
            PixelatedVolumeComponent myVolume = VolumeManager.instance.stack?.GetComponent<PixelatedVolumeComponent>();
            if (myVolume != null)
                s_SharedPropertyBlock.SetFloat(kPixelsPropertyId, myVolume.pixelCount.value);
